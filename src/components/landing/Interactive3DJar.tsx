  ...
  return (
    <group ref={jarRef}>
      ...
      <group ref={capRef} position={[0, 0.92, 0]}>
        ...
        <Text position={[0, 0.165, 0.008]} rotation={[-Math.PI / 2, 0, 0]} fontSize={0.32} color="#1e0533" anchorX="center" anchorY="middle">Vivlit</Text>
        <Text position={[0, 0.17, 0]} rotation={[-Math.PI / 2, 0, 0]} fontSize={0.32} color="#e9d5ff" anchorX="center" anchorY="middle">Vivlit</Text>
      </group>
    </group>
  );
};
...
const NoteOverlay = ({ 
  ...
  const messages = [
    "✨ You are capable of amazing things ✨", "💕 You make the world a softer place 💕", "🌟 Your potential is endless 🌟", "💫 Small steps are still progress 💫", "🦋 Trust the timing of your life 🦋", "🌻 Keep growing, keep glowing 🌻", "🌙 Rest is productive too 🌙", "💖 You are enough, just as you are 💖", "🌈 Storms don't last forever 🌈", "✨ Your energy is magnetic ✨", "🌿 Breathe. You’ve got this 🌿", "💌 You are loved more than you know 💌", "🌟 Believe in your own magic 🌟", "💫 Everything you need is within you 💫", "🌷 Bloom where you are planted 🌷", "🌞 You bring sunshine to others 🌞", "💪 You have survived 100% of your bad days 💪", "💕 Be kind to yourself today 💕", "✨ The best is yet to come ✨", "🌊 You are stronger than the waves 🌊", "🕊️ Peace begins with you 🕊️", "🌟 Focus on the good 🌟", "🦋 Embrace your own journey 🦋", "💫 Dream big, worry small 💫", "🍂 Let go of what you can't control 🍂", "💖 Your heart is pure gold 💖", "✨ Create your own happiness ✨", "🛤️ You are on the right path 🛤️", "🧘‍♀️ Inhale confidence, exhale doubt 🧘‍♀️", "🌟 You are a masterpiece in progress 🌟", "💕 Your feelings are valid 💕", "🌺 Good things take time 🌺", "💫 Make today count 💫", "🐢 Slow progress is still progress 🐢", "✨ You inspire people around you ✨", "🌈 Happiness looks good on you 🌈", "💖 Protect your peace 💖", "🌟 You are exactly where you need to be 🌟", "🦋 Don't forget to fly 🦋", "💫 You are worthy of all good things 💫"
  ];
